...
#define QS_INDEX_TYPES (ef)(single)(uniform)(opt)(block_optpfor)(block_varint)(block_interpolative)(block_u32)(block_vbyte)(block_simple16)(block_anspacked)(block_anspackedminmax)(block_anspackedmed90p)(block_ansmsb)
