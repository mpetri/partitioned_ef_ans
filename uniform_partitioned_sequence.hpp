    ...
    public:
            ...
            , m_bv(&bv)
        {
            ...
            if (m_partitions == 1) {
                ...
                m_partition_enum = base_sequence_enumerator(*m_bv, it.position(), ub + 1, n, m_params);
    ...
    private:
        ...
        void switch_partition(uint64_t partition)
        {
            ...
            uint64_t endpoint = partition
                ? m_bv->get_bits(m_endpoints_offset + (partition - 1) * m_endpoint_bits,
                      m_endpoint_bits)
                : 0;
            ...
            m_partition_enum = base_sequence_enumerator(*m_bv, m_sequences_offset + endpoint,
