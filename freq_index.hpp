...
public:
    ...
    public:
            ...
            FreqsIterator freqs_begin, uint64_t occurrences)
        {
            ...
            std::shared_ptr<list_adder<DocsIterator, FreqsIterator>>
                ptr(new list_adder<DocsIterator, FreqsIterator>(*this, docs_begin,
    ...
    {
        visit(m_params, "m_params")(m_num_docs, "m_num_docs")(m_docs_sequences, "m_docs_sequences")(m_freqs_sequences, "m_freqs_sequences");
    }
