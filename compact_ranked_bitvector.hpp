    ...
    private:
        value_type QS_NOINLINE slow_move(uint64_t position)
        {
            ...
            if (position > m_position
                ...
                m_enumerator = succinct::bit_vector::unary_enumerator(*m_bv, m_of.bits_offset + ptr_pos);
        ...
        value_type QS_NOINLINE slow_next_geq(uint64_t lower_bound)
        {
            ...
            m_enumerator = succinct::bit_vector::unary_enumerator(*m_bv, m_of.bits_offset + lower_bound);
